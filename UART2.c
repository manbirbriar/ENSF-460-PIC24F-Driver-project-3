...
void Disp2String(char *str) //Displays String of characters
{
    ...
    // Clear the current line by moving the cursor back and printing enough spaces
    XmitUART2('\r', 1);  // Move cursor to the beginning of the line
    for (i = 0; i < 40; i++) {  // Print 40 spaces to clear the line (adjust based on line length)
        XmitUART2(' ', 1);
    }
    
    XmitUART2('\r', 1);  // Move cursor back to the beginning of the line again after clearing
